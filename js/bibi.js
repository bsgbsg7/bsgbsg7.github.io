...
let items = []
let page = 1
let Url = 'https://memos.itisn.cyou/api/memo?openId=cf9af344-5908-423b-a729-91e7bf627ad7&page=' // 修改api，记得带参数page
...
function getNew() {
    ...
    bibi.innerHTML += '<div id="bb_loading"><img src="/img/loading3.gif" alt="bb_loading"></div>' 
